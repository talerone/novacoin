...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("talers"));
    case mBTC: return QString(QObject::tr("Milli-talers (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-talers (1 / 1,000,000)"));
    default: return QString("???");
    }
}
